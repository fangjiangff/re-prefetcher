...
def plot_heatmaps():
    ...
    for i, sheet_name in enumerate(valid_sheets):
        ...
        try:
            ...
            # 绘制热力图
            sns.heatmap(df, cmap="viridis", annot=False, ax=ax, vmin=20, vmax=400, cbar=(i == num_sheets - 1), yticklabels=(i == 0))
    ...
    plt.tight_layout()
    output_path = os.path.join(OUTPUT_DIR, "threshold-microarch.png")
