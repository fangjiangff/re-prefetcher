...
int main(void) {
    ...
    t0_no_trigger = run_case(array2, array2, array2, NULL,
                             TRIGGER_NONE, stride);
    t0 = run_case(array2, array2, array2, NULL,
                  TRIGGER_NOINLINE, stride);
    t1 = run_case(array2, array2, array2, NULL,
    ...
    printf("# T0 uses mStore_noinline for train and trigger: same PC/VA/PA\n");
    printf("# T1 uses mStore_noinline for train and mStore_inline for trigger: different PC, same VA/PA\n");
    ...
    print_result("T0_no_trigger", "same_all_without_trigger", "same", "same",
                 "same", t0_no_trigger);
    print_result("T0", "same_all_with_noinline_trigger", "same", "same",
                 "same", t0);
    print_result("T1", "different_pc_same_va_pa", "different", "same",
                 "same", t1);
    print_result("T2", "different_va_same_pa", "same", "different",
                 "same", t2);
