...
def parse_args():
    ...
    parser.add_argument("--other-pages", type=int, default=DEFAULT_OTHER_PAGES,
                        help=f"Number of other physical pages trained before victim trigger. Default: {DEFAULT_OTHER_PAGES}")
